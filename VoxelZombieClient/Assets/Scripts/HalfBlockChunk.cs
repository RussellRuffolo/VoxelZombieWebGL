...
// public class HalfBlockChunk : MonoBehaviour, IChunk
// {
//     public IWorld world;
...
//     {
//         var xMask = new ushort[CHUNK_SIZE * CHUNK_SIZE * 2];
//         int x = 0, y = 0, z = 0;
//
//         //Sweep X axis
//         for (x = -1; x < CHUNK_SIZE;)
//         {
//             var xCounter = 0;
//
//             //compute the mask
...
//             {
//                 for (y = 0; y < CHUNK_SIZE * 2; ++y)
//                 {
//                     int yCoord = (y / 2);
//                     bool topHalf = y % 2 == 1;
//                     bool blockCompare = x >= CHUNK_SIZE - 1;
//                     blockCompare = blockCompare || IsEmptyBlock(x + 1 + chunkPosX,
//                         yCoord + chunkPosY, z + chunkPosZ, topHalf);
//
//                     uint current = 0;
//
//
//                     if (blockCompare)
//                     {
//                         xMask[xCounter++] = GetBlock(x + chunkPosX, yCoord + chunkPosY, z + chunkPosZ, topHalf);
//                     }
//                     else
//                     {
//                         bool blockCurrent = (x < 0) ||
//                                             IsEmptyBlock(x + chunkPosX, y + chunkPosY, z + chunkPosZ, topHalf);
//                         if (blockCurrent)
//                         {
//                             xMask[xCounter++] = (ushort) (UInt16.MaxValue - GetBlock(x + 1 + chunkPosX,
//                                 y + chunkPosY, z + chunkPosZ, topHalf));
//                         }
//                         else
//                         {
//                             xMask[xCounter++] = 0;
...
//             {
//                 for (int i = 0; i < CHUNK_SIZE * 2;)
//                 {
//                     if (xMask[xCounter] != 0)
//                     {
//                         ushort blockTag = xMask[xCounter];
//                         int w;
//
//                         // Compute the width of this quad and store it in w                        
//                         //   This is done by searching along the current axis until mask[n + w] is false
//                         for (w = 1; i + w < CHUNK_SIZE * 2 && xMask[xCounter + w] == blockTag; w++)
//                         {
//                         }
//
...
//                                 if (xMask[xCounter + k + h * CHUNK_SIZE * 2] != blockTag)
//                                 {
//                                     done = true;
//                                     break;
//                                 }
...
//                         int yCoord = i / 2;
//
//                         AppendQuad(new Vector3(x, i * .5f, j), // Top-left vertice position
//                             new Vector3(x, (i + w) * .5f, j), // Top right vertice position
//                             new Vector3(x, i * .5f, j + h), // Bottom left vertice position
//                             new Vector3(x, (i + w) * .5f,
//                                 j + h), blockTag // Bottom right vertice position
//                         );
//
//
...
//                         for (int l = 0; l < h; ++l)
//                         for (int k = 0; k < w; ++k)
//                             xMask[xCounter + k + l * CHUNK_SIZE * 2] = 0;
//
...
//     }
//
//     private bool IsEmptyBlock(int x, int y, int z, bool topHalf)
//     {
//         uint combinedId = world[x, y, z];
//
//         if (topHalf)
//         {
//             return ((ushort) (combinedId >> 16)) == 0;
//         }
//
//         return ((ushort) (combinedId)) == 0;
//     }
//
...
//     }
//
//     private ushort GetBlock(int x, int y, int z, bool topHalf)
//     {
//         uint combinedId = world[x, y, z];
//
//         if (topHalf)
//         {
//             return ((ushort) (combinedId >> 16));
//         }
//
//         return ((ushort) (combinedId));
//     }
//
